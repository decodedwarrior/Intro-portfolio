...
export default function ExperienceSection() {
  return (
    <section className="bg-gradient-to-r from-green-700 to-teal-700 text-white py-20 px-6 rounded-lg max-w-4xl mx-auto flex flex-col md:flex-row items-center space-y-10 md:space-y-0 md:space-x-16">
      
      {/* Image on left */}
      <div className="flex-shrink-0">
        <img
          src="/avatar.png" // your avatar image here
          alt="Sumit Moharana"
